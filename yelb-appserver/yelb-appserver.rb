...
get '/api/getvotes' do
    ...
    content_type 'application/json'
    @google = restaurantsdbread("google")
    @aws = restaurantsdbread("aws")
    @ibmcloud = restaurantsdbread("ibmcloud")
    @azure = restaurantsdbread("azure")
    @votes = '[{"name": "google", "value": ' + @google + '},' + '{"name": "ibmcloud", "value": ' + @ibmcloud + '},' + '{"name": "aws", "value": '  + @aws + '}, ' + '{"name": "azure", "value": '  + @azure + '}]'
...
get '/api/ibmcloud' do
    ...
    restaurantsdbupdate("ibmcloud")
    @ibmcloud = restaurantsdbread("ibmcloud")
end #get /api/ibmcloud 
